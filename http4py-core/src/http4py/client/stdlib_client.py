...
from http4py.core import Request, Response, Status


def stdlib_client(request: Request) -> Response:
    """
    ...
    try:
        ...
        urllib_request = urllib.request.Request(url=url, data=body_data, headers=headers, method=request.method.name)
